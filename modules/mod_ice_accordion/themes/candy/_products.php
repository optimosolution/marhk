...
<?php for( $i=$limitstart; $i< $limit; $i++) : ?>
		...
		?>
			...
			<span class="<?php echo $show_preview?'iceAccordionTip':''; ?>"  width="<?php echo $previewWidth; ?>" height="<?php echo $previewHeight;?>" rel="<?php echo $show_preview?$item->thumbnail:'';?>" title="<?php echo  $show_preview?$item->title:'';?>"><?php echo $item->title ?></span></h4>
