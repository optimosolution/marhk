...
{
	/**
	 * IceGroupK2 Class  extends the LofSliderGroupBase Class
	 */		
	 class IceGroupK2 extends IceGroupBase
	 {
		/**
		 * @var string $__name 
		 *
		...
		public function parseImages(&$row)
		{
			...
			{
				$row  = IceGroupK2::lookingForK2Image($row);
				if($row->imageK2Image != '')
				{
