<?php
/**
 * @version	$Id: paramhelp.php 13 2011-04-28 07:08:24Z ty2u $
 * @package	mod_date2
...
class JElementparamhelp extends JElement
{
    var $_name = "paramhelp";
 
    function fetchElement($name, $value, &$node, $control_name) {
        return '<a name="' . $value . '"></a><a href="#top">Goto Top</a><br /><a href="#' . $value . '">' . JText::_($value). '</a><hr style="clear:both;" />';
    }
}
