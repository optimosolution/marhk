...
?><div class="phocagallery-box-file-i">
	...
	<div class="name"><?php echo $this->_tmp_img->name; ?></div>
		<div class="detail" style="text-align:right">
			<a href="#" onclick="if (window.parent) window.parent.<?php echo $this->fce; ?>('<?php echo $this->_tmp_img->nameno; ?>');"><?php echo JHTML::_( 'image', 'administrator/components/com_phocagallery/assets/images/icon-insert.gif', JText::_('COM_PHOCAGALLERY_INSERT_IMAGE'), array('title' => JText::_('COM_PHOCAGALLERY_INSERT_IMAGE'))); ?></a>
		</div>
